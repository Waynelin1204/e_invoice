...
class TWB2BMainItemInS(models.Model):
    company= models.ForeignKey("e_invoices.Company", on_delete=models.PROTECT, related_name="twb2bmainitemins_invoices",blank=True, null=True)  # 公司代碼
    ...
    seller_id = models.CharField(max_length=60, blank=True, null=True) #統一編號
    ...
    buyer_id = models.CharField(max_length=10,blank=True, null=True) #買方統編
    ...
    carrier_type = models.CharField(max_length=10,blank=True, null=True)  # 載具類別
    carrier_id1 = models.CharField(max_length=10,blank=True, null=True)  # 載具顯碼
    carrier_id2 = models.CharField(max_length=10,blank=True, null=True)  # 載具隱碼
    ...
    reserved2 = models.CharField(
        ...
        blank=True, 
        null=True)
    sales_amount = models.DecimalField(max_digits=13, decimal_places=1,blank=True, null=True)
    freetax_sales_amount = models.DecimalField(max_digits=13, decimal_places=1,blank=True, null=True)
    zerotax_sales_amount = models.DecimalField(max_digits=13, decimal_places=1,blank=True, null=True)
    ...
    total_amount = models.DecimalField(max_digits=13, decimal_places=1,blank=True, null=True)
    original_currency_amount = models.DecimalField(max_digits=13, decimal_places=1, blank=True, null=True)
    exchange_rate = models.DecimalField(max_digits=8, decimal_places=1, blank=True, null=True)
    ...
    reject_time = models.TimeField(blank=True, null=True)
    reject_reason = models.CharField(max_length=225, blank=True, null=True)
    reject_remark = models.CharField(max_length=225, blank=True, null=True)
   # 稅局拒絕理由
    def __str__(self):
        return f"{self.sys_number}"

class TWB2BLineItemInS(models.Model):
    twb2bmainitemins = models.ForeignKey(TWB2BMainItemInS, related_name='items', on_delete=models.CASCADE)  # TWB2BMainItem
    ...
    line_unit_price = models.DecimalField(max_digits=20, decimal_places=1,blank=True, null=True)  # 單價
    ...
    line_tax_amount = models.DecimalField(max_digits=20, decimal_places=1,blank=True, null=True) #稅金

class TWB2BMainItemInE(models.Model):
    company= models.ForeignKey("e_invoices.Company", on_delete=models.PROTECT, related_name="twb2bmainitemine_invoices",blank=True, null=True)  # 公司代碼
    b2b_b2c = models.CharField(max_length=3, choices=[('B2B', 'B2B'), ('B2C', 'B2C')], blank=True, null=True)  # B2B/B2C
    sys_number = models.CharField(max_length=20,blank=True, null=True) # 平台文件號碼
    sys_date = models.DateTimeField(blank=True, null=True)    #  平台匯入日期
    export_date = models.DateField(blank=True, null=True)    #  平台匯出日期
...
class TWB2BLineItemInE(models.Model):
    twb2bmainitemine = models.ForeignKey(TWB2BMainItemInE, related_name='items', on_delete=models.CASCADE)  # TWB2BMainItem
    erp_number = models.CharField(max_length=20,blank=True, null=True)    # ERP文件號碼(主表也有，自己用於快速查找)
    line_sequence_number = models.CharField(max_length=4,blank=True, null=True)  # 明細排列序號
    line_description = models.CharField(
        max_length=500,
