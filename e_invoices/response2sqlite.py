...
# Path to XML file in Downloads folder
downloads_folder = os.path.expanduser("/home/pi/Downloads/Response/")
xml_file_path = os.path.join(downloads_folder, "Application response KCH AUTOMATION SDN BHD dca0ddea-d282-47fb-a561-5a7794f7a7d6.xml")  # Replace with actual file name
