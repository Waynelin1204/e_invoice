...
def draw_table_first_page(invoice, draw, canvas, start_cm, column_widths_cm, headers, data_rows, sales_amount, total_tax_amount, company_name, total_amount, company_identifier, company_address, wrap_text_fn=draw_wrapped_text):
    dpi = 300
