...
xml_file_path = os.path.join(downloads_folder, "ADVANTECH_CO._MALAYSIA_SDN_BHD_MY01202500953954730001_0_original.xml")  # Replace with actual file name
...
supplier_id = root.find("cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID", namespaces).text  
...
supplier_scheme_id = root.find("cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID", namespaces).text  
...
buyer_supp_assign_id = root.find("cac:AccountingCustomerParty/cbc:SupplierAssignedAccountID", namespaces).text 
...
#AccountingContact
buyer_account_name = root.find("cac:AccountingCustomerParty/cac:AccountingContact/cbc:Name", namespaces).text 
buyer_account_phone = root.find("cac:AccountingCustomerParty/cac:AccountingContact/cbc:Telephone", namespaces).text 
buyer_account_email = root.find("cac:AccountingCustomerParty/cac:AccountingContact/cbc:ElectronicMail", namespaces).text 
...
prepaid_amount = root.find("cac:LegalMonetaryTotal/cbc:PrepaidAmount", namespaces).text
payable_amount = root.find("cac:LegalMonetaryTotal/cbc:PayableAmount", namespaces).text
